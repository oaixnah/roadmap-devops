...
### 从源代码到可运行程序 {#from-source-code-to-runnable-program}
...
### 自动化程序的工程边界 {#engineering-boundaries-of-automation}
...
## 语言与工具链 {#languages-and-toolchains}
...
### JavaScript 与 Node.js {#javascript-and-node-js}
...
## 最小实践：只读目录清单工具 {#minimal-practice-read-only-directory-listing-tool}
...
### 可维护性与交付 {#maintainability-and-delivery}
