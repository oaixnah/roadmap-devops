...
### 容器不是轻量虚拟机 {#containers-are-not-lightweight-virtual-machines}
...
### namespaces：隔离视图 {#namespaces-isolated-views}
...
### cgroups：资源核算与限制 {#cgroups-resource-accounting-and-limits}
...
### capabilities、seccomp 与强制访问控制 {#capabilities-seccomp-and-mandatory-access-control}
...
### 镜像、层与运行容器 {#images-layers-and-running-containers}
...
### Dockerfile 与构建上下文 {#dockerfile-and-build-context}
...
### 非特权与特权容器 {#unprivileged-and-privileged-containers}
...
### 网络、存储与生命周期 {#networking-storage-and-lifecycle}
...
## 最小实践：最小权限 Docker 容器 {#minimal-practice-least-privilege-docker-container}
...
### 可选构建实践 {#optional-build-practice}
...
### LXC 专项基线 {#lxc-specific-baseline}
