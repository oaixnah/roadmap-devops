...
### 进程、服务与启动 {#processes-services-and-boot}
...
### 文件、身份与权限 {#files-identities-and-permissions}
...
#### RHEL 及衍生发行版 {#rhel-and-derived-distributions}
...
## 最小实践：采集系统事实 {#minimal-practice-collect-system-facts}
...
### 建立可重复基线 {#establish-a-reproducible-baseline}
...
### 补丁与生命周期 {#patching-and-lifecycle}
...
### 权限与防护 {#permissions-and-protection}
